...
- [ ] Bluetooth communications with Pebble mobile app
- [ ] Basic application runtime compatible with Pebble SDK
- [ ] Display driver and graphics subsystem
...
| Platform | SoC | Status |
|----------|-----|--------|
| Asterix (p2ddk) | nRF52840 | Primary target |
